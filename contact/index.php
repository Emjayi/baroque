...
$page_description =
	'Be in Touch with Baroque , contact info, address, telephone, email and online links. ' . $site_owner . ', architect and designer';
...
?>
<!-- go back button -->
<button class="hide-until-load header-button" id="go-back" onclick="this.blur();">
	...
	<div class="container contact-container" id="contact-container">
		...
		<section class="contact-section">
			...
			<ul class="contact-text-section">
				<li>
					<a class="contact-item" href="#" id="show-map-btn">
				...
				<li>
					<!-- phone -->
					<a class="contact-item" href="tel:<?php e($phone); ?>" target="_blank">
						<span class="contact-icon">
							<?php phoneicon() ?>
						</span>
						<span class="contact-link-txt">
				...
				<li>
					<!-- mobile -->
					<a class="contact-item" href="tel:<?php e($phone_mob); ?>" target="_blank">
						<span class="contact-icon">
							<?php mobicon() ?>
						</span>
						<span class="contact-link-txt">
				...
				<li>
					<!-- email -->
					<a class="contact-item" target="_blank" id="email-link" href="#" data-mail="info"
						data-mailinfo="<?php e($domain_name); ?>">
						<span class="contact-icon">
							<?php mailicon() ?>
						</span>
						<span class="contact-link-txt">
		...
		<section class="contact-section">
			...
			<ul class="contact-text-section">
				<li>
					<!-- instagram -->
					<a class="contact-item" href="<?php e($insta_location); ?>" target="_blank">
						<span class="contact-icon">
							<?php instaicon() ?>
						</span>
						<span class="contact-link-txt">
				...
				<li>
					<!-- linked In-->
					<a class="contact-item" href="<?php e($linkedin_location); ?>" target="_blank">
						<span class="contact-icon">
							<?php linkedInicon() ?>
						</span>
						<span class="contact-link-txt">
				...
				<li>
					<!-- facebook -->
					<a class="contact-item" href="<?php e($facebook_location); ?>" target="_blank">
						<span class="contact-icon">
							<?php fbicon() ?>
						</span>
						<span class="contact-link-txt">
				...
				<li>
					<!-- telegram -->
					<a class="contact-item" href="<?php e($telegram_location); ?>" target="_blank">
						<span class="contact-icon">
							<?php telegramicon() ?>
						</span>
						<span class="contact-link-txt">
