...
smoothState - ajax page load animation 
...
(function() {
  ...
  function GeminiScrollbar(config) {
	...
	this.primeryScrolbar = false;
	this.functionArterScrolCahnge = function () {return false};
  ...
  GeminiScrollbar.prototype._scrollHandler = function _scrollHandler() {
	...
	var dx = this._trackLeftMax;
	var dy = this._trackTopMax;
	this.functionArterScrolCahnge(x,y,dx,dy);
