...
// load admin head
$page_title = 'مدیریت بخش تیم در صفحه درباره ما';
...
<!-- ===== title ===== -->
<a href="index.php">
	<h2>افزودن یک نفر به به بخش تیم ، درباره ما</h2>
</a>
<!-- ===== upload form ===== -->
<div class="form-con ">

	<h3 id="main-title" class="<?php echo $className ?>">ارسال فولدر زیپ شده </h3>
	...
	<?php } else if ($_GET["upload"] == 'folderNameExists') { ?>
		<div class="respond respond-error">خطا در نام فولدر، در حال حاضر دقیقا یک مشتری دیگر با همین نام در سایت وجود دارد</div>
	...
	<form enctype="multipart/form-data" action="project-upload.php" method="post" name="news_form">
		...
		<!-- download file -->
		<div class="label">فولدر زیپ شده (عضو جدید تیم) را اپلود کنید
		...
		<!-- submit-->
		<input type="submit" value="ارسال فولدر زیپ شده تیم" class="submit" />
