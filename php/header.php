...
<body class="<?php
	echo $pageClass;
	if(isset($bodyClass)) echo ' '.$bodyClass;
	if(isset($pageClass_noJS)) echo ' '.$pageClass_noJS;
?>">
...
<header class="main-container" id="header">
	...
	<div class="site-title" id="site-title">
		<h2><b>mrk<span></span></b><i>office<!-- <span></span> --></i></h2>
	</div>
	...
	<!-- instagram button -->
	<a href="<?php echo $insta_location; ?>"
	   class="menu-soc focusable"
	   target="_blank"
	   tabindex="-1" >
