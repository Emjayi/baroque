...
function e($texttt)
{
    echo htmlspecialchars($texttt);
}

// a function that convert relative paths to absolute ones
function makePathAbs($pathh)
{
    global $rootPath;
    $pathhIndex = strripos($pathh, '../');
    $pathh = substr($pathh, $pathhIndex);
    $pathh = str_replace('../', $rootPath, $pathh);
    return str_replace(' ', '%20', $pathh);
}

// desable displaying  error 
error_reporting(0);